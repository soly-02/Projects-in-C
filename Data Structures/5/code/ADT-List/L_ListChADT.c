...
*/
{
   int i;
    ...
    {
        Node[i].Next=i+1;
        Node[i].Data=-1;    /* Οχι αναγκαία εντολή, βοηθητική για να φαίνονται στην εκτύπωση η τιμή των δεδομένων Data */
    }
    Node[NumberOfNodes-1].Next=NilValue;
    Node[NumberOfNodes-1].Data=-1;      /* Οχι αναγκαία εντολή, βοηθητική για να φαίνονται στην εκτύπωση η τιμή των δεδομένων Data */
    *FreePtr=0;
}
